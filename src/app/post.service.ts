...
export class PostService {
  ...
  getPost(index?:number) {
    return index ? this.listOfPosts[index] : new Post()
  }

  likePost(index: number) {
    let numberOfLike = this.listOfPosts[index].numberOfLike ?? 0
    this.listOfPosts[index].numberOfLike = this.listOfPosts[index].numberOfLike ? numberOfLike+1 : 1;
  }
}
